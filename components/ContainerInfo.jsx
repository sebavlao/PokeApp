...
export const ContainerInfo = ({ name, types, stats, color, id }) => {
  ...
  return (
    <ScrollView className="bg-white rounded-t-3xl p-2 -z-10 h-screen">
        ...
        <Pressable className={`${colorClasses[color]} rounded-md self-center mt-5 px-2 py-1`} onPress={() => addToTeam(id)}>
